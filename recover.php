...
else
{
	...
	show_image_code ();
	?>
	<tr><td class="toolbox" colspan="2" align="center"><input type="submit" value="<?php echo $lang_recover['submit_recover_it'] ?>"  onclick="javascript:{this.disabled=true;this.form.submit()}"  /></td></tr>
	</table></form>
	<?php
	stdfoot();
}
