...
<td class="rowfollow" align="left">
<input type="radio" name="inclbookmarked" id="inclbookmarked0" value="0" checked="checked" /><label for="inclbookmarked0"><?php echo $lang_getrss['text_all']?></label>&nbsp;
<input type="radio" name="inclbookmarked" id="inclbookmarked1" value="1" /><label for="inclbookmarked1"><?php echo $lang_getrss['text_only_bookmarked']?></label>&nbsp;
<input type="radio" name="inclbookmarked" id="inclbookmarked2" value="2" /><label for="inclbookmarked2"><?php echo $lang_getrss['text_only_bookmarked']."且未完成"?></label>
