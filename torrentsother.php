					...
					<tr>
						<td class="bottom" type ="hide" style="padding: 1px;padding-left: 10px">
							<select class="med" name="incldead" style="width: 100px;" >
								...
								<option value="3"<?php print($include_dead == 3 ? " selected=\"selected\"" : ""); ?>>BANNED</option>
								<option value="4"<?php print($include_dead == 4 ? " selected=\"selected\"" : ""); ?>>无IMDB</option><?php } ?>
					...
					<tr>
						...
						<td class="embedded">
							<table>
								<tr>
									<td class="embedded">
										<input id="searchinput" name="search" type="text" value="<?php echo  $searchstr_ori ?>" autocomplete="off" style="width: 300px" ondblclick="suggest(event.keyCode,this.value);" onkeyup="suggest(event.keyCode,this.value);" onkeypress="return noenter(event.keyCode);"/>
