...
<script src="javascript/curtain_imageresizer.js<?echo $cssupdatedate?>" type="text/javascript"></script><style type="text/css">body {overflow-y:scroll; overflow-x: hidden;min-width: 1px;}</style>
