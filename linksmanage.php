...
<tr><td class=rowhead>X</td><td><input type=text name=X style="width: 200px"></td></tr>
<tr><td class=rowhead>Y</td><td><input type=text name=Y style="width: 200px"></td></tr>
...
<tr><td class=rowhead>X</td><td><input type=text name=X size=40 value="<?php echo $row['X'];?>"></td></tr>
<tr><td class=rowhead>Y</td><td><input type=text name=Y size=40 value="<?php echo $row['Y'];?>"></td></tr>
