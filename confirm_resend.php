...
?>
	...
	show_image_code();
	?>
	<tr><td class="toolbox" colspan="2" align="center"><input type="submit"  onclick="javascript:{this.disabled=true;this.form.submit()}"  value="<?php echo $lang_confirm_resend['submit_send_it'] ?>" /></td></tr>
	</table></form>
	<?php
	stdfoot();
}
